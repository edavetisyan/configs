...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_h), spawn $ "konsole 'htop task manager' -e btop" )
  ...
  , ((modMask, xK_Return), spawn $ "konsole" )
  ...
  , ((controlMask .|. shiftMask , xK_Return ), spawn $ "bash layout_switch.sh")
  --SCREENSHOTS

  , ((0, xK_Print), spawn $ "scrot 'ArcoLinux-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'")
  , ((controlMask, xK_Home), spawn $ "xfce4-screenshooter" )
  , ((controlMask .|. shiftMask , xK_Home), spawn $ "gnome-screenshot -i")
